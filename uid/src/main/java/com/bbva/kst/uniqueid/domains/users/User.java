...
public class User {
	...
	public final OcrData au10tixData;
	...
	private User(Builder builder) {
		...
		this.au10tixData = builder.au10tixData;
	...
	public static class Builder {
		...
		public User.Builder toBuild(User userEncrypted) {
			...
			this.au10tixData = userEncrypted.au10tixData;
		...
		public User.Builder au10tixData(OcrData au10tixEncriptedKey) {
			this.au10tixData = au10tixEncriptedKey;
			return this;
		}
