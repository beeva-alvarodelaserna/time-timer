...
public class MultipartSetupDurationAndNameOfStepsFragment extends BaseFragment<MultipartSetupDurationAndNameOfStepsView, BaseInteractor> {
	...
	public static MultipartSetupDurationAndNameOfStepsFragment newInstance(int numberOfSteps) {
		MultipartSetupDurationAndNameOfStepsFragment fragment =
			MultipartSetupDurationAndNameOfStepsFragment.newInstance();
	...
	protected MultipartSetupDurationAndNameOfStepsView getFragmentView() {
		return new MultipartSetupDurationAndNameOfStepsView(new MultipartSetupDurationAndNameOfStepsView.ViewListener() {
